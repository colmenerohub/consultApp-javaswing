...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-11-2023 a las 00:33:54
...
-- Procedimientos
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `mayorEsperanza` ()   BEGIN
	DECLARE cont int DEFAULT 1;
	DECLARE vContinente varchar(30);
	DECLARE continenteAnterior varchar(30) DEFAULT 'aaron';
	DECLARE vPais varchar(30);
	DECLARE vVida FLOAT;
	DECLARE vIndependencia int(4);
	DECLARE vGobierno varchar(30);
	DECLARE fin int DEFAULT 0;
	DECLARE cursor_mayorEsperanza CURSOR FOR SELECT continent, name, lifeExpectancy, indepYear, GovernmentForm
									FROM country  
									ORDER BY continent, lifeExpectancy DESC;
	DECLARE CONTINUE HANDLER FOR NOT FOUND SET fin = 1;

	OPEN cursor_mayorEsperanza;
		REPEAT
			FETCH cursor_mayorEsperanza INTO vContinente, vPais, vVida, vIndependencia, vGobierno;
			IF NOT vContinente=continenteAnterior THEN		
				SET cont = 1;
				SET continenteAnterior = vContinente;	
			END IF;
			IF cont <= 5 THEN
				SELECT CONCAT(cont, " ", vContinente) "Continente", vPais, vVida, vIndependencia, vGobierno; 
				SET cont = cont + 1;
			END IF;
		UNTIL fin
		END REPEAT;
	CLOSE cursor_mayorEsperanza;
END$$
...
(53, 'TafunaFUN', 'ASM', 'Abu Dhabi', 5200),
...
(670, 'A Pabluña', 'ESP', 'Galicia', 300000),
...
('CHN', 'China', 'Asia', 'Eastern Asia', '9572900.00', -1523, 1277558000, '71.4', '982268.00', '917719.00', 'Zhongquo', 'Peoples Republic', 'Jiang Zemin', 1891, 'CN'),
